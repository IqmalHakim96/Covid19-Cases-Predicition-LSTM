...
class ExploratoryDataAnalysis():
    ...
    def knn_imputer(self, data ,n_neighbors=2):
        ...
        temp_date = data['date']
        df_imputed = imputer.fit_transform(temp) #turning the float result to array
    ...
    def train_process(self, data1, data2, window_size=30):
    ...
    def test_process(self, data, window_size=30):
...
class ModelCreation():
    ...
    def lstm_layer(self, data, nodes=64, dropout=0.5, output=1):
        '''
